...
| TiDB Serverless   | Connect your TiDB Serverless to Auto-GPT. | [pingcap/Auto-GPT-TiDB-Serverless-Plugin](https://github.com/pingcap/Auto-GPT-TiDB-Serverless-Plugin)
