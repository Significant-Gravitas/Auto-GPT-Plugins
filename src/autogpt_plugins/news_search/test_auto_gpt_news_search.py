...
class TestNewsSearch():
    ...
    def mock_response(self, *args, **kwargs):
      ...
      if kwargs['q'] == "AI" and kwargs['category'] == "technology":
         ...
         return json.loads("""{"status":"ok","totalResults":1,"articles": [{"title": "World Cup"}]}""")
          ...
          return json.loads("""{"status": "ok","totalResults": 1,"articles": [{"title": "The National enlist Taylor Swift for new song “The Alcott”"}]}""")
      else:
    ...
    def test_news_search(self):
      ...
      assert actual_output_taylor.count(['Taylor Swift']) == 1
      assert actual_output_taylor.count([]) == 4
