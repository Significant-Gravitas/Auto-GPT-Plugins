...
| Text Parser |  Read text from several types of files directly without converting them to .txt files. | [autogpt_plugins/text_parser](https://github.com/Significant-Gravitas/Auto-GPT-Plugins/tree/master/src/autogpt_plugins/text_parser)
