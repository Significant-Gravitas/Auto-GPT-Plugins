...
| Todo List | Give Auto-GPT a simple utility to keep track of tasks outside of the prompt, and give users a way to create todo lists without plain text files. | [autogpt_plugins/todo_list](https://github.com/Significant-Gravitas/Auto-GPT-Plugins/tree/master/src/autogpt_plugins/todo_list)
